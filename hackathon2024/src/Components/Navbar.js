      ...
      <nav className="navbar">
        <div className="navbar-container">
          <Link to="/" className="navbar-logo" onClick={closeMobileMenu}>
            IMMG <i className="fa-solid fa-soap" />
          </Link>
          ...
          <ul className={click ? 'nav-menu active' : 'nav-menu'}>
            ...
            <li className='nav-item'>
              <Link to='/games' className='nav-links' onClick={closeMobileMenu}>
                <img src='/path/to/games-icon.png' alt='Games' />
              </Link>
            </li>
            <li className='nav-item'>
              <Link to='/websites' className='nav-links' onClick={closeMobileMenu}>
                <img src='/path/to/websites-icon.png' alt='Websites' />
              </Link>
            </li>
            <li className='nav-item'>
              <Link to='/information' className='nav-links' onClick={closeMobileMenu}>
                <img src='/path/to/information-icon.png' alt='Information' />
              </Link>
            </li>
          </ul>
        </div>
